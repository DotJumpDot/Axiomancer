<script lang="ts">
  ...
  import CostBreakdownWidget from "./widgets/CostBreakdownWidget.svelte";
  import HourlyUsageWidget from "./widgets/HourlyUsageWidget.svelte";
  import ModelPerformanceWidget from "./widgets/ModelPerformanceWidget.svelte";
  ...
  function openInNewTab() {
    // Navigate to the dedicated analytics page
    navigate(`/analytics?days=${days}`);
    onClose();
  }
      ...
      <div class="header-actions">
        {#if lastUpdated}
          <span class="last-updated">
            {t.analytics?.lastUpdated || "Updated"}: {formatLastUpdated(lastUpdated)}
          </span>
        {/if}
